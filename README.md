...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2022-09-17 01:42`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/5b64ee06-23a6-4ffb-be66-ffb7f877095b.git
$ cd 5b64ee06-23a6-4ffb-be66-ffb7f877095b
```
